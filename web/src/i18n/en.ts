...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the NASP gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    updateNastechConfirmTitle: "Update NASP?",
    updatingNastech: "Updating NASP…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update NASP plugins (`nastech plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that NASP doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "NASP Achievements",
      subtitle:
        "Collectible NASP badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning NASP session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run NASP more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once NASP sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "NASP is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in NASP ☤",
    },
  },
